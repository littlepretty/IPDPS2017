...
% % Given the critical role of burst buffer in future HPC I/O system,
...
% % the novel burst buffer equipped HPC I/O subsystem and
...
% % user's application by acutely absorb the bursty checkpoint-purpose I/O request;
