...
% In the first phases, input data are staged in from I/O nodes to burst buffer.
...
% Burst buffer plays as an efficient I/O broker for compute nodes,
% in replacing of traditional I/O nodes.
...
\textbf{Running}: The scheduler allocates the job with the required
         ...
         There may also in-situ/in-transit data analytics/visualization in large simulation applications.
